...
var GameLayer = cc.Layer.extend({
	...
	init: function() {
		...
		// Ball
		this.ball = Game.createPhysicsSprite(res.ballpng, 1, 0, true, this.collisionTypeBall);
